"""Produces solved networks: runs PyPSA-Eur in the pinned sibling checkout, sanctions candidates.
...
from pipeline.sources.pypsa_eur import CANDIDATES_DIR, NETWORKS_DIR, REPO, candidate_filename, network_filename
