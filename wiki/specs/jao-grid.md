...
**Scope: one day, 2024-08-29.** The shelf holds 2013-07-17 only; step 1 solves this day. Everything below is built and accepted for that day alone. If a sweep over a longer range turns out to be needed to synthesise anything, that is a later, separate decision.
