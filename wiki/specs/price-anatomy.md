...
- **Actual**: `coppersushi/electricity_maps.py`, day-ahead price `past-range`, hourly, per zone, for the day; result committed beside the network so the demo needs no network. Zones = countries; for DK, IT, NO and SE the bidding zone containing the capital. Stretch: bidding-zone geometry.
