...
1. **Fork refresh** ([procedure and hygiene](../pypsa-eur-fork.md)): old master → `legacy-2022`; master = upstream; branch `coppersushi-opf` off master; pixi env. No 2022 commits are carried (the cherry-pick experiment showed 41 of 46 conflict and the rest are trivia). *(Sep 2–3)*
