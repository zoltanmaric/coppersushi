...
- [core-day-ahead-capacity-calculation.md](core-day-ahead-capacity-calculation.md) — how the numbers that limit Core's day-ahead trade come about: vocabulary, one published row read column by column, the eleven steps from the TSOs' grid models to the auction's shadow prices, who acts and who decides
